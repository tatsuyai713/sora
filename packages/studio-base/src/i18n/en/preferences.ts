...
export default {
  ...
  ros: "ROS",
  privacy: "Privacy",
  privacyDescription: "Changes will take effect the next time sviz is launched.",
  extensions: "Extensions",
  about: "About",
  sendAnonymizedUsageData: "Send anonymized usage data to help us improve sviz",
  ...
  studioDebugPanelsDescription: "Show sviz debug panels in the “Add panel” list.",
