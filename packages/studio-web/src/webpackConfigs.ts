...
export const mainConfig =
  ...
  <html>
    <head>
      ...
      <meta property="og:title" content="sviz"/>
      ...
      <meta property="og:url" content="https://sviz.metaverseindustries.llc/"/>
    ...
    <script>
      ...
      globalThis.FOXGLOVE_STUDIO_EXTENSIONS = [/*FOXGLOVE_STUDIO_EXTENSIONS_PLACEHOLDER*/][0];
    </script>
    <body>
      <div id="root"></div>
    </body>
